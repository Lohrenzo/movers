  ...
  return (
    ...
    >
        <SwiperSlide className='flex flex-col items-center justify-center text-center font-[Cambria] text-white h-full w-full'>
            ...
            <p className='text-[0.9rem] w-[80%]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim voluptate libero quos. Est, accusamus? Maiores placeat, fugit iste, tenetur, qui odit fugiat eius minus necessitatibus reiciendis nam iusto neque nobis?</p>
        </SwiperSlide>
        ...
        <SwiperSlide className='flex flex-col items-center justify-center text-center font-[Cambria] text-white h-full w-full'>
            ...
            <small>Customer</small>
            <p className='text-[0.9rem] w-[80%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, natus praesentium. Eos eum molestias, nam nostrum autem provident repellendus facere sapiente beatae. Nihil tempora ea eos tempore provident deserunt totam?</p>
        </SwiperSlide>
        ...
        <SwiperSlide className='flex flex-col items-center justify-center text-center font-[Cambria] text-white h-full w-full'>
            ...
            <small>Customer</small>
            <p className='text-[0.9rem] w-[80%]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam mollitia corporis sequi error quo laudantium provident, sint doloremque nulla iure nostrum enim voluptates libero perspiciatis sapiente exercitationem. Sapiente, illum harum?</p>
        </SwiperSlide>
    </Swiper>
  )
}
