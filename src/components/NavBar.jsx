...
const NavBar = () => {
  ...
  return (
    <nav className='relative top-0 right-0 left-0 shadow-md h-[18vh] lg:px-[8rem] px-[2rem] text-[1.4rem] bg-white flex items-center justify-between'>
        ...
        <ul className={`capitalize px-3 py-4 rounded-br-lg grid grid-cols-1 gap-x-[2rem] justify-center items-center absolute top-[18vh] bg-white w-[80%] z-10`} style={{ left: menuOpen ? "0" : "-1000px", transition: "left 0.5s ease-in-out" }}>
